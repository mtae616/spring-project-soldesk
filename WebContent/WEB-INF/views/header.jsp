...
<script type="text/javascript">
	var socket = new WebSocket("ws://localhost:8080/SpringMVC1/websocket");
...
<body>
	...
	<header>
		<div class="inner">
			<a href="${root }main" class="logo"> <img
				src="${root }images/logo1.png" alt="">
			</a>
			<div class="sub-menu">
				<ul class="menu">
					<c:choose>
		...
		<c:otherwise>
			<ul class="main-menu">
				...
				<li class="item">
					<div class="item__name">
						<a href="${root}signin" onclick="alert1()">구매신청하기</a>
					</div>
					<div class="item__contents">
						<div class="contents__menu">
							<ul class="inner">
